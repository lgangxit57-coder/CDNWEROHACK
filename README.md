...
Auditor de cámaras IP + fuerza bruta de servicios para pruebas de
penetración **autorizadas** (red propia o cliente con alcance firmado).
...
git clone git@github.com:TU_USUARIO/cdnhack.git
cd cdnhack
chmod +x cdnhack.py
